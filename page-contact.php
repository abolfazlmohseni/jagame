        ...
        <div class="text-center animate__animated animate__fadeIn">
            ...
            <div class="flex justify-center gap-3">
                ...
                <a href="#" class="social-icon bg-secondary rounded-full w-14 h-14 flex items-center justify-center hover:bg-primary transition-colors duration-300">
                    <svg class="size-6 text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                ...
                <!-- LinkedIn -->
                <a href="#" class="social-icon bg-secondary rounded-full w-14 h-14 flex items-center justify-center hover:bg-primary transition-colors duration-300">
                    <svg class="size-6 text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                ...
                <!-- Facebook -->
                <a href="#" class="social-icon bg-secondary rounded-full w-14 h-14 flex items-center justify-center hover:bg-primary transition-colors duration-300">
                    <svg class="size-6 text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                ...
                <!-- Twitter -->
                <a href="#" class="social-icon bg-secondary rounded-full w-14 h-14 flex items-center justify-center hover:bg-primary transition-colors duration-300">
                    <svg class="size-6 text-white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
