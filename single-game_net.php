...
<head>
    ...
    <style>
        ...
        .bg-primary { background-color: #4B3F72; }
        .text-primary { color: #4B3F72; }
        .bg-secondary { background-color: #8E7CC3; }
        .text-secondary { color: #8E7CC3; }
        .bg-accent { background-color: #FFD447; }
        .text-accent { color: #FFD447; }
