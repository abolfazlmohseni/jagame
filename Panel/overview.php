...
<div class="w-4/5 p-4">
    ...
    <div class="flex gap-4 mb-6">
        <div class="stat-card p-5 rounded-lg w-full md:w-1/4 shadow-lg ">
            <p class="text-sm">تعداد کل دستگاه‌ها</p>
            <p id="totalDevices" class="text-2xl font-bold mt-2">0</p>
        </div>
        <div class="bg-white p-5 rounded-lg w-full md:w-1/4 shadow-lg">
        ...
        devices.forEach(device => {
            ...
            tableContent += `
                <tr class="border-b border-gray-100 hover:bg-gray-50 device-row">
                    ...
                    <td class="py-3 px-4">
                        <button class="edit-device text-blue-600 hover:text-blue-800 ml-2" data-id="${device.id}">
                            <i class="fas fa-edit ml-1"></i>
                            ویرایش
                        </button>
                        <button class="delete-device text-red-600 hover:text-red-800" data-id="${device.id}">
